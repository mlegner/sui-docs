...
2.  Browse to the [Sui repo](https://github.com/MystenLabs/sui) on GitHub.
3.  Choose **Fork** in the top-right, then choose **Create new fork**.
4.  For **Owner**, select your username.
5.  For **Repository name**, you can use any name you want, but some find it easier to track if you use the same name as the source repo.
...
-   Read the [Sui Smart Contract Platform](https://github.com/MystenLabs/sui/blob/main/doc/paper/tokenomics.pdf/) white paper.
    ...
    -   Find related [research papers](../reference/research-papers.mdx).
